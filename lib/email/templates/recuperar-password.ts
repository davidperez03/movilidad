  ...
  return baseLayout(`
    ...
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
      <tr><td align="center" style="padding:4px 0 8px;">
        <a href="${resetUrl}" style="display:inline-block;background-color:#171717;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;padding:12px 32px;border-radius:6px;">Restablecer contraseña</a>
      </td></tr>
    </table>
    ...
    <span style="color:#6b7280;word-break:break-all;">${resetUrl}</span></p>
  `)
}
