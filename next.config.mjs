...
const SECURITY_HEADERS = [
  ...
  // CSP enforcement. unsafe-inline/unsafe-eval requeridos por Next.js (Turbopack).
  // Migrar a nonce-based CSP cuando Next.js soporte nonces estables en App Router.
  {
