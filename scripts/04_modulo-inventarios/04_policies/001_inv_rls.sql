-- RLS para módulo de inventarios
-- SELECT: superadmin o usuario con acceso al módulo del ítem
-- INSERT/UPDATE: superadmin o usuario con permiso 'gestionar_inventario' en el módulo
-- DELETE: solo superadmin (los movimientos son inmutables por diseño)
