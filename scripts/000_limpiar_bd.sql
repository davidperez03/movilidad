...
-- ⚠️ ADVERTENCIA: Este script ELIMINA TODOS LOS DATOS Y ESTRUCTURAS
-- ============================================================================
...
-- ============================================================================
-- ELIMINAR TODAS LAS FUNCIONES (excepto las de extensiones)
-- ============================================================================
...
BEGIN
    FOR r IN (
        ...
        AND d.objid IS NULL  -- Excluir funciones que dependen de extensiones
    ) LOOP
...
-- ============================================================================
-- ELIMINAR TODOS LOS TIPOS PERSONALIZADOS (excepto los de extensiones)
-- ============================================================================
...
BEGIN
    FOR r IN (
        ...
        AND d.objid IS NULL  -- Excluir tipos que dependen de extensiones
    ) LOOP
